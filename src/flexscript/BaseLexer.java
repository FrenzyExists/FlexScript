...
public class BaseLexer {
    ...
    static enum TokenType {
        ...
        Op_equal, Op_notequal, Op_assign, Op_and, Op_or,Keyword_for, Keyword_if,
        Keyword_else,Keyword_elif, Keyword_while, Keyword_print, Keyword_putc, LeftParen, RightParen,
    ...
    BaseLexer(String source) {
        ...
        this.keywords.put("elif", TokenType.Keyword_elif);
    ...
    public static void main(String[] args) {
        if (args.length > 0) {
            try {
                ...
                BaseLexer l = new BaseLexer(source);
                l.printTokens();
